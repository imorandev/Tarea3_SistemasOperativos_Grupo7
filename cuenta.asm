...
main(int argc, char *argv[])
{
  ...
  1d:	50                   	push   %eax
  1e:	68 58 07 00 00       	push   $0x758
  23:	6a 01                	push   $0x1
  25:	e8 c6 03 00 00       	call   3f0 <printf>
	exit();
...
00000340 <printint>:
 ...
 379:	0f b6 92 98 07 00 00 	movzbl 0x798(%edx),%edx
...
000003f0 <printf>:
 ...
 576:	bb 8f 07 00 00       	mov    $0x78f,%ebx
...
000005c0 <free>:
 ...
 5c4:	55                   	push   %ebp
 5c5:	a1 40 0a 00 00       	mov    0xa40,%eax
 ...
 611:	5b                   	pop    %ebx
 612:	a3 40 0a 00 00       	mov    %eax,0xa40
 617:	5e                   	pop    %esi
 618:	5f                   	pop    %edi
 619:	5d                   	pop    %ebp
 61a:	c3                   	ret    
 ...
 63a:	a3 40 0a 00 00       	mov    %eax,0xa40
...
00000650 <malloc>:
 ...
 660:	8b 3d 40 0a 00 00    	mov    0xa40,%edi
 ...
 6a9:	8b 3d 40 0a 00 00    	mov    0xa40,%edi
 ...
 6d7:	a1 40 0a 00 00       	mov    0xa40,%eax
 ...
 707:	a3 40 0a 00 00       	mov    %eax,0xa40
 ...
 720:	c7 05 40 0a 00 00 44 	movl   $0xa44,0xa40
 727:	0a 00 00 
 72a:	bf 44 0a 00 00       	mov    $0xa44,%edi
 72f:	c7 05 44 0a 00 00 44 	movl   $0xa44,0xa44
 736:	0a 00 00 
 739:	89 f8                	mov    %edi,%eax
 73b:	c7 05 48 0a 00 00 00 	movl   $0x0,0xa48
 742:	00 00 00 
